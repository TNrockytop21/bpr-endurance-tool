...
import { handleAgentConnection, handleViewerConnection } from './ws-handler.js';
...
import { broadcastToAllViewers } from './broadcast.js';
app.post('/api/streamdeck', (req, res) => {
  broadcastToAllViewers('streamdeck:command', req.body);
  res.json({ ok: true });
});
